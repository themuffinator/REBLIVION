...
- For each task completion, estimate before and after parity percentages versus the retail Oblivion mod source base outlined in the Binary Ninja HLIL references.
