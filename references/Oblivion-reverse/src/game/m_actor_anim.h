...
// This file contains the actor animation frame macros.
// It is intentionally separate from m_actor.h so that the actor-specific
// frame names do not collide with the player frame macros when both
// headers are included in the same translation unit.

#ifndef M_ACTOR_ANIM_H
#define M_ACTOR_ANIM_H
